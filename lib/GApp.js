        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/login', render: function render(props) {
                return !(window.sessionStorage.isLoggedIn == true || window.sessionStorage.isLoggedIn == 'true') ? (0, _react.createElement)(loginPage || _Login2.default, { location: location, appName: appName, authClient: authClient, restClient: restClient }, null) : _react2.default.createElement(_reactRouterDom.Redirect, { to: {
                    pathname: '/',
