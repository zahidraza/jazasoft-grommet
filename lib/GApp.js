(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'redux', 'react-redux', 'history/createHashHistory', 'react-router-dom', 'react-router-redux', './reducers', 'redux-logger', 'redux-thunk', 'redux-promise-middleware', './components/Dashboard', './components/Login', './components/Protected', './components/GLayout', 'grommet/components/App'], factory);
...
})(this, function (exports, _react, _propTypes, _redux, _reactRedux, _createHashHistory, _reactRouterDom, _reactRouterRedux, _reducers, _reduxLogger, _reduxThunk, _reduxPromiseMiddleware, _Dashboard, _Login, _Protected, _GLayout, _App) {
  'use strict';
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/login', render: function render(props) {
                return !isAuth() ? (0, _react.createElement)(loginPage || _Login2.default, { appName: appName, authClient: authClient, restClient: restClient }, null) : _react2.default.createElement(_reactRouterDom.Redirect, { to: {
                    pathname: '/',
