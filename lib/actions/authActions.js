(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', '../rest/authTypes', '../rest/types'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../rest/authTypes'), require('../rest/types'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.authTypes, global.types);
    global.authActions = mod.exports;
  }
})(this, function (exports, _authTypes, _types) {
  'use strict';
