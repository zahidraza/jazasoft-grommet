            ...
            var colItems = rowItem.map(function (colItem, i) {
              ...
              if (colItem.type == 'input') {
                ...
                cell = _react2.default.createElement(
                  _GTableCell2.default,
                  { key: i },
                  _react2.default.createElement('input', { type: 'text', name: colItem.name, value: colItem.value == undefined ? '' : colItem.value, style: { width: _width2 }, onChange: _this2._onInputChange.bind(_this2, idx, colItem.name, colItem.action) })
                );
              }
              ...
              if (colItem.type == 'date') {
                ...
                cell = _react2.default.createElement(
                  _GTableCell2.default,
                  { key: i },
                  _react2.default.createElement(_DateTime2.default, { name: colItem.name, format: 'DD MMM, YY', value: colItem.value, onChange: _this2._onDateChange.bind(_this2, idx, colItem.name, colItem.action) })
                );
              }
              return cell;
            });
