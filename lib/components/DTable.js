(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-redux', 'grommet/components/Box', 'grommet/components/Button', 'grommet/components/CheckBox', 'grommet/components/DateTime', 'grommet/components/Table', 'grommet/components/TableRow', './GTableCell', 'grommet/components/TableHeader', 'grommet/components/List', 'grommet/components/ListItem', 'grommet/components/icons/base/Trash', './Dailog', 'react-toolbox/lib/tooltip'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-redux'), require('grommet/components/Box'), require('grommet/components/Button'), require('grommet/components/CheckBox'), require('grommet/components/DateTime'), require('grommet/components/Table'), require('grommet/components/TableRow'), require('./GTableCell'), require('grommet/components/TableHeader'), require('grommet/components/List'), require('grommet/components/ListItem'), require('grommet/components/icons/base/Trash'), require('./Dailog'), require('react-toolbox/lib/tooltip'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactRedux, global.Box, global.Button, global.CheckBox, global.DateTime, global.Table, global.TableRow, global.GTableCell, global.TableHeader, global.List, global.ListItem, global.Trash, global.Dailog, global.tooltip);
    global.DTable = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactRedux, _Box, _Button, _CheckBox, _DateTime, _Table, _TableRow, _GTableCell, _TableHeader, _List, _ListItem, _Trash, _Dailog, _tooltip) {
  'use strict';
            ...
            var colItems = rowItem.map(function (colItem, i) {
              ...
              if (colItem.type == 'input') {
                ...
                cell = _react2.default.createElement(
                  _GTableCell2.default,
                  { key: i },
                  _react2.default.createElement('input', { type: 'text', disabled: colItem.disabled == undefined ? false : colItem.disabled, name: colItem.name, value: colItem.value == undefined ? '' : colItem.value, style: { width: _width2 }, onChange: _this2._onInputChange.bind(_this2, idx, colItem.name, colItem.action) })
                );
              }
            ...
            var colItems = rowItem.map(function (colItem, i) {
              ...
              if (colItem.type == 'input') {
                ...
                cell = _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'text', disabled: colItem.disabled == undefined ? false : colItem.disabled, name: colItem.name, value: colItem.value, style: { width: width }, onChange: _this2._onInputChange.bind(_this2, idx, colItem.name, colItem.action) })
                );
              }
              if (colItem.type == 'checkbox') {
