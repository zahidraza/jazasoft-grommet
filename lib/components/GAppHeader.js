    ...
    _createClass(GAppHeader, [{
      ...
      value: function render() {
        return _react2.default.createElement(
          _Header2.default,
          { size: 'large', justify: 'between', style: { background: '#0b3c5d' }, pad: { horizontal: 'medium' } },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Anchor2.default,
              { style: { color: '#ffffff' }, path: '/profile' },
              sessionStorage.name
            ),
            _react2.default.createElement(
              _Anchor2.default,
              { style: { color: '#ffffff' }, path: '/login', onClick: this._onLogout },
              'Logout'
            )
          )
        );
