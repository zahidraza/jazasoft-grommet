    ...
    */
    ...
    _createClass(GForm, [{
      ...
      value: function componentWillMount() {
        ...
        if (collectionData != undefined) {
          ...
          collectionData.forEach(function (cData, idx) {
            ...
            _elements[idx] = cData.elements.map(function (e) {
              if (e.type == 'input') {
          ...
          this.setState({ collection: collection, elements: _elements, dialogActive: dialogActive });
        }
      }
    }, {
      key: '_onSubmit',
      ...
      value: function _onDInputChange(index, name, event) {
        ...
        this.props.dispatch({ type: _formActions.FORM_CHANGE_BASIC, payload: { collections: [].concat(_toConsumableArray(dtElements)) } });
      }
    }, {
