    ...
    _createClass(GForm, [{
      ...
      value: function componentWillMount() {
        ...
        if (collectionData != undefined) {
          ...
          collectionData.forEach(function (cData, idx) {
            ...
            coll.selectedItems.forEach(function (e) {
              ...
              if (typeof e === 'string') {
                ...
                var id = e.id,
                    restData = _objectWithoutProperties(e, ['id']);
          ...
          this.setState({ collection: collection, elements: elements, dtElements: dtElements, dialogActive: dialogActive });
        }
      }
    }, {
      key: '_onSubmit',
      ...
      value: function _onDInputChange(row, col, name, event) {
        ...
        this.props.dispatch({ type: _formActions.FORM_CHANGE_COLLECTION, payload: { row: row, col: col, item: _extends({}, dtElements[row][col]) } });
      }
    }, {
      key: '_onDDateChange',
      ...
      value: function _submitDailog(index) {
        ...
        if (typeof currItem === 'string') {
          ...
          var _currItem = currItem,
              id = _currItem.id,
              restData = _objectWithoutProperties(_currItem, ['id']);
        ...
        this.props.dispatch({ type: _formActions.FORM_CHANGE_COLLECTION, payload: { row: index, item: rowItem } });
      }
    }, {
      key: 'render',
          ...
          var fieldsets = data.map(function (fieldset, idx) {
            ...
            var elements = fieldset.elements.map(function (e, i) {
              ...
              if (e.elementType == 'select') {
                var _type2 = e.type != undefined ? e.type : 'text';
