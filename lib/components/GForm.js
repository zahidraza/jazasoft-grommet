(function (global, factory) {
  ...
  var GForm = function (_Component) {
    ...
    _createClass(GForm, [{
      ...
      value: function _onDInputChange(index, name, event) {
        ...
        this.props.dispatch({ type: _formActions.FORM_CHANGE, payload: _defineProperty({}, this.props.collectionKey, [].concat(_toConsumableArray(dtElements))) });
      }
    }, {
      ...
      value: function _onRemove(index) {
        ...
        this.props.dispatch({ type: _formActions.FORM_CHANGE, payload: _defineProperty({}, this.props.collectionKey, [].concat(elements)) });
      }
    }, {
      key: '_submitDailog',
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            secondaryTitle = _props2.secondaryTitle,
            headers = _props2.headers,
            collectionKey = _props2.collectionKey,
  ...
  GForm.propTypes = {
    ...
    collectionKey: _propTypes2.default.string,
