    ...
    _createClass(GLayout, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            restProps = _objectWithoutProperties(_props, ['resources', 'dashboard', 'links', 'appName', 'appShortName']);

        var header = void 0;
        if (this.props.location.pathname != '/login') {
          header = _react2.default.createElement(_GAppHeader2.default, { appName: appName, onMenuOpen: this._openDrawer });
        }

        var pane1 = this.state.drawerActive ? _react2.default.createElement(_GSidebar2.default, { links: links, appShortName: appShortName, onHide: this._closeDrawer }) : null;
