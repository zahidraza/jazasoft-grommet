(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-router-dom', 'react-redux', '../actions/authActions', 'grommet/components/App', 'grommet/components/Box', 'grommet/components/Heading', 'grommet/components/Form', 'grommet/components/FormField', 'grommet/components/FormFields', 'grommet/components/Button', 'grommet/components/Footer', 'grommet/components/icons/Spinning'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-router-dom'), require('react-redux'), require('../actions/authActions'), require('grommet/components/App'), require('grommet/components/Box'), require('grommet/components/Heading'), require('grommet/components/Form'), require('grommet/components/FormField'), require('grommet/components/FormFields'), require('grommet/components/Button'), require('grommet/components/Footer'), require('grommet/components/icons/Spinning'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactRouterDom, global.reactRedux, global.authActions, global.App, global.Box, global.Heading, global.Form, global.FormField, global.FormFields, global.Button, global.Footer, global.Spinning);
    global.Login = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactRouterDom, _reactRedux, _authActions, _App, _Box, _Heading, _Form, _FormField, _FormFields, _Button, _Footer, _Spinning) {
  'use strict';
