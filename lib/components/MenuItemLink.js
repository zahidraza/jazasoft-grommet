(function (global, factory) {
  ...
  var MenuItemLink = function (_Component) {
    ...
    _createClass(MenuItemLink, [{
      ...
      value: function render() {
        return _react2.default.createElement(_Anchor2.default, { style: { color: '#ffffff' }, className: this.props.className, label: this.props.label, onClick: this.handleClick });
      }
    }]);
