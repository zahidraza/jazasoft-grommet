(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-router-dom', 'react-redux', 'grommet/components/icons/base/Add', 'grommet/components/Box', 'grommet/components/Button', 'grommet-addons/components/FilterControl', 'grommet/components/Header', 'grommet/components/icons/base/Help', 'grommet/components/Title', 'grommet/components/Search'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-router-dom'), require('react-redux'), require('grommet/components/icons/base/Add'), require('grommet/components/Box'), require('grommet/components/Button'), require('grommet-addons/components/FilterControl'), require('grommet/components/Header'), require('grommet/components/icons/base/Help'), require('grommet/components/Title'), require('grommet/components/Search'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactRouterDom, global.reactRedux, global.Add, global.Box, global.Button, global.FilterControl, global.Header, global.Help, global.Title, global.Search);
    global.PageHeader = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactRouterDom, _reactRedux, _Add, _Box, _Button, _FilterControl, _Header, _Help, _Title, _Search) {
  'use strict';
    ...
    _createClass(PageHeader, [{
      ...
      value: function render() {
        ...
        var _props$filter = this.props.filter,
            filteredTotal = _props$filter.filteredTotal,
            unfilteredTotal = _props$filter.unfilteredTotal;
        ...
        return _react2.default.createElement(
          _Header2.default,
          { id: 'page-header', justify: justify, fixed: false, size: 'large', pad: { horizontal: 'medium' } },
  ...
  exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(select)(PageHeader));
});