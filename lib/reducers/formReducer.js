(function (global, factory) {
  ...
  var handlers = (_handlers = {}, _defineProperty(_handlers, _formActions.FORM_CHANGE_BASIC, function (_, action) {
    ...
    return { formData: {}, collectionData: [], toggleForm: !_.toggleForm };
  }), _defineProperty(_handlers, _formActions.OPERATION_COMPLETED, function (_, action) {
    return { formData: {}, collectionData: [], opCompleted: true };
  }), _defineProperty(_handlers, _routerAction.LOCATION_CHANGE, function (_, action) {
    return { formData: {}, collectionData: [], toggleForm: !_.toggleForm, opCompleted: false };
  }), _handlers);
