(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'axios', '../actions/errActions', '../actions/notificationActions', '../actions/authActions', './types'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('axios'), require('../actions/errActions'), require('../actions/notificationActions'), require('../actions/authActions'), require('./types'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.axios, global.errActions, global.notificationActions, global.authActions, global.types);
    global.RestClient = mod.exports;
  }
})(this, function (exports, _axios, _errActions, _notificationActions, _authActions, _types) {
  'use strict';
